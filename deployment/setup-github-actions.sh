...
echo ""
echo "MEASUREMENT_PROTOCOL_API_SECRET (obtenha no Google Analytics):"
echo "  Configure este valor manualmente como Secret"
echo ""
echo "💡 Próximos passos:"
echo "  1. Vá para: https://github.com/${GITHUB_REPO_OWNER}/${GITHUB_REPO_NAME}/settings/secrets/actions"
echo "  2. Crie os secrets: WIF_PROVIDER, WIF_SERVICE_ACCOUNT, ADMIN_KEY e MEASUREMENT_PROTOCOL_API_SECRET"
